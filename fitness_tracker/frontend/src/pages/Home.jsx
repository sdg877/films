...
//             return (
//               activity.user && activity.user.toString() === user._id.toString()
//             );
//           });
    ...
    if (user) {
      const fetchActivities = async () => {
        ...
        try {
          ...
          const filteredActivities = response.data.data.filter((activity) => {
            // Add a check for activity.user and user._id
            return (
              activity.user && activity.user._id && activity.user._id === user._id
            );
          });
    ...
    <div className="p-4">
      ...
      {loading ? (
        ...
        <div className="text-center my-4">
          ...
          <Link to="/activity/create" className="text-blue-500 underline">
            Add an Activity
          </Link>
        </div>
      ) : (
